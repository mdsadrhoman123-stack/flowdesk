...
<img src="assets/demo.gif" alt="FlowDesk: one execution running step by step, a step failing on purpose — held and escalated, in red — then that same step handled and the run completing" width="100%">

<p align="center">92 nodes · <b>8 failure paths, every one alerted</b> · 3 AI failsafe tiers · 5 production versions</p>
...
<img src="assets/output.png" alt="FlowDesk: sample of the output a client receives, including one step that failed and what happened instead" width="100%">
