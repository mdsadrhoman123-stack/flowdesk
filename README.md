...
<img src="assets/demo.gif" alt="FlowDesk: the flow completing on a good run, then Break it pressed — every failure path lit in red with what the system does about it — then the flow restored" width="100%">
